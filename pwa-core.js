    ...
    <div id="pwa-card">
      ...
      <div id="pwa-block-android" hidden>
        ...
        <div class="pwa-after-note">
          ✅ Sau khi cài xong, hãy tìm và mở app đã cài — không cần vào link này nữa.<br>
          🗑️ Để gỡ cài đặt: Chuột phải vào icon → <b>Gỡ cài đặt</b> (PC) hoặc giữ icon → <b>Xoá</b> (Android)
        </div>
      </div>
